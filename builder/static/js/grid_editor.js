...
const getDefinition = (word) => {
    const url = `https://fruzzled.ie/api/builder/get_definition/${word}/`;
...
const addEventListeners = () => {
    ...
    document.getElementById('matches-button').addEventListener('click', (event) => {
        ...
        const url = `https://fruzzled.ie/api/builder/query/${queryString}`;
    ...
    document.getElementById('save-button').addEventListener('click', (event) => {
        ...
        const url = 'https://fruzzled.ie/api/builder/save_puzzle/';
        const options = {
            method: 'POST',
            body: payload,
            headers: {
