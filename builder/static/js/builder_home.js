...
const renderThumbnails = (json) => {
    ...
    const createdDate = new Date(json.puzzle.created_on);
    ...
    const lastEditDate = new Date(json.puzzle.created_on);
    ...
    title.innerText = `Created by ${json.puzzle.creator} on ${lastEditDateString}`;
...
const createThumbnail = (json) => {
    ...
    for (let clue of clues) {
        ...
        console.log(startIndex + ',' + clue.solution);
